...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        #print(self.mdp.getTransitionStatesAndProbs((0,0), 'east'))
        #print(self.mdp.getReward((0,0), 'north', (0,1)))
        #print(self.discount)
        ...
        for i in range(self.iterations):
            ...
            for state in self.mdp.getStates():
                ...
                ## Choosing the optimal value of Q_value
    ...
    def computeQValueFromValues(self, state, action):
        ...
        # Sigma(s') T(s,a,s')[R(s,a,s') + gamma V_k(s')]
        # Computing the Q value of V(s,a)
        q_val = 0
        for s_prime, T in self.mdp.getTransitionStatesAndProbs(state, action):
            print(str(s_prime) + ' ' + str(T))
            q_val += T * (self.mdp.getReward(state, action, s_prime) + self.discount*self.getValue(s_prime))
    ...
    def computeActionFromValues(self, state):
        ...
        for action in self.mdp.getPossibleActions(state):
            S[action] = self.getQValue(state, action)
